...
$(document).ready(function () {
  ...
  $.ajax({
    url: 'server.php',
    method: 'GET',
    success: function success(datiInArrivo) {
...
__webpack_require__(/*! /mnt/c/MAMP/htdocs/boolean/43/php-ajax-dischi/src/js/main.js */"./src/js/main.js");
module.exports = __webpack_require__(/*! /mnt/c/MAMP/htdocs/boolean/43/php-ajax-dischi/src/scss/style.scss */"./src/scss/style.scss");
